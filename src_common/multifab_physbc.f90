module multifab_physbc_module
  ...
  public :: multifab_physbc, multifab_physbc_domainvel, multifab_physbc_macvel
...
!!!!!!!!!!!!!!!!!!
  ...
  subroutine physbc_domainvel_inhomogeneous_2d(s,ng_s,vel_bc_n,ng_v,lo,hi,bc,bccomp,dx)
...
!!!!!!!!!!!!!!!!!!
  ...
  subroutine physbc_domainvel_inhomogeneous_3d(s,ng_s,vel_bc_n,ng_v,lo,hi,bc,bccomp,dx)
...
!!!!!!!!!!!!!!!!!!
  ...
  subroutine physbc_macvel_inhomogeneous_2d(s,ng_s,v_bc,ng_v,lo,hi,bc,bccomp,dx)
