! This module stores the runtime parameters.  The probin_common_init() routine is
! used to initialize the runtime parameters
! Amit: caution: this module just cannot be used like it for our case as the way
! it passes input are different than us 
...
module probin_common_module
  ...
  ! Boundary conditions
  !----------------------
  ! BC specifications: !Amit: This is different for us
  ! -1 = periodic
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    dim_in = 2
    prob_lo(1:MAX_SPACEDIM) = -1.d0
    prob_hi(1:MAX_SPACEDIM) = 1.d0
    n_cells(1:MAX_SPACEDIM) = 256
