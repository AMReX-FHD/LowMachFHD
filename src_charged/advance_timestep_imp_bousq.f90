...
contains
  ...
  subroutine advance_timestep_imp_bousq(mla,umac,rho_old,rho_new,rhotot_old,rhotot_new, &
    ...
    ! compute "old" advective momentum term, m_a_fluxdiv_old = div(-rho^n v^n v^n)
    do n=1,nlevs
       do i=1,dm
    ...
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ! Step 1 - Solve Poisson equation and compute potential mass fluxes
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    do n=1,nlevs
       ...
       call multifab_saxpy_3_cc(rho_new(n),1,1.d0, adv_mass_fluxdiv_old(n),1,nspecies)
       call multifab_saxpy_3_cc(rho_new(n),1,1.d0,diff_mass_fluxdiv_old(n),1,nspecies)
       if (variance_coef_mass .ne. 0.d0) then
          call multifab_saxpy_3_cc(rho_new(n),1,1.d0,stoch_mass_fluxdiv_old(n),1,nspecies)
       end if
    ...
    ! add dt*Epot_mass_fluxdiv to RHS to get rho^{n+1,*}
    do n=1,nlevs
       call multifab_saxpy_3_cc(rho_new(n),1,dt,Epot_mass_fluxdiv(n),1,nspecies)
    end do
...
! this should be at the end of the corrector
