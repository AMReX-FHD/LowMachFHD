########################################################
##
## This is a README for the electro-osmosis 2d input files. 
##
########################################################

All are meant to have a cell depth in z of approximately 1*dx=1*dy to mimic the effect of fluctuations in a 3d simulation
with dx=dy=dz. 

The main differences between the three electro-osmosis 2d files are the values for (i) c_init, (ii) E_ext, and (iii) Epot_wall
...
#####################
      ...
      The script 'compute_debye_len_and_epot.f90' prints out the correct value of 
...
inputs_electroosmosis1_2d_spc                       2.56d-6                                           50
inputs_electroosmosis2_2d_spc                       1.28d-5                                           10
inputs_electroosmosis3_2d_spc                       6.4d-5                                             2
