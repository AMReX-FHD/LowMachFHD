...
#OPT3="--max_step 2000   --plot_int 0   --print_int 100 --hydro_grid_int 1 --n_steps_skip 1000 --histogram_unit 10"
...
if [ -f dimerization.S_k.pair=1.Re.dat ]
then
  ../../../analysis/Sk/Sk_2d.sh dimerization 
fi
