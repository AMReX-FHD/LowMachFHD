...
PROG=../../main.Linux.gfortran.debug.mpi.exe    
                                       # reactdiff program
INPUTS=../../inputs_Dirichlet_BC_determ_2d       
...
MY_OPTIONS="--temporal_integrator 1 --reaction_type 1 --diffusion_type 1 --inhomogeneous_bc_fix T"
#MY_OPTIONS="--temporal_integrator 1 --reaction_type 1 --diffusion_type 1 --inhomogeneous_bc_fix F"
#MY_OPTIONS="--temporal_integrator -2"  # since this is an explicit scheme, decrease dt_fixed. see below. 

NTEST=5                                # total number of runs 
...
# MGSX=128
# MGSY=128
# DT=0.00001      # for explicit schemes, use smaller fixed_dt and increase max_step accordingly.
# MAXSTEP=1000
