...
\begin{eqnarray}
\rho_{\text{top}} & = & \rho_{0}\left(1+\alpha_{1}Z_{1}^{0}\right)=\left(1.0+4\cdot10^{-2}\times10^{-2}\right)\, g/cm^{3}=\left(1.0+4\cdot10^{-4}\right)\, g/cm^{3},\label{eq:ics}\\
\rho_{\text{bottom}} & = & \rho_{0}\left(1+\alpha_{2}Z_{2}^{0}\right)=\left(1.0+12.2\cdot10^{-2}\times2.9\cdot10^{-3}\right)\, g/cm^{3}=\left(1+3.54\cdot10^{-4}\right)\, g/cm^{3}.\nonumber 
\end{eqnarray}
In terms of the partial densities we have
\[
\rho_{1}^{0}=Z_{1}^{0}M_{1}=7.46\cdot10^{-4}\, g/cm^{3},\quad\rho_{2}^{0}=Z_{2}^{0}M_{2}=9.93\cdot10^{-4}\, g/cm^{3},
\]
