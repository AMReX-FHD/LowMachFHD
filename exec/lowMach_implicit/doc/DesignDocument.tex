...
If this is the beginning of the simulation, we perform a projection to obtain an initial velocity
field.
\begin{equation}
\nabla\cdot\vb^0 = S^0.
\end{equation}
{\bf Step 1: Forward Euler Thermodynamic Predictor:}
\begin{eqnarray}
...
{\bf Step 3: Trapezoidal Thermodynamic Corrector:}
\begin{eqnarray}
