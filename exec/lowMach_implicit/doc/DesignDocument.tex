...
\begin{equation}
\left(\frac{\rho^{*,n+1}}{\Delta t} - \half\mathcal{A}_0\right)\deltab\vb + \nabla\delta\pi = \frac{(\rho^n-\rho^{*,n+1})\vb^n}{\Delta t} -\nabla\pi^n + \nabla\cdot(-\rho^n\vb^n\vb^n) + \mathcal{A}_0\vb^n + \nabla\cdot\Sigmab^n,\label{eq:CN Vel Pred}
\end{equation}
\begin{equation}
\nabla\cdot\deltab\vb = S^{*,n+1} - \nabla\cdot\vb^n.
\end{equation}
...
\begin{equation}
\left(\frac{\rho^{n+1}}{\Delta t} - \half\mathcal{A}_0\right)\deltab\vb + \nabla\delta\pi = \frac{(\rho^n-\rho^{n+1})\vb^n}{\Delta t} -\nabla\pi^n + \half\nabla\cdot(-\rho^n\vb^n\vb^n - \rho^{n+1}\vb^{*,n+1}\vb^{*,n+1}) + \mathcal{A}_0\vb^n + \nabla\cdot\Sigmab^n,
\end{equation}
\begin{equation}
\nabla\cdot\deltab\vb = S^{n+1} - \nabla\cdot\vb^n.
\end{equation}
