...
\begin{equation}
\Wb + \Wb^T = \sqrt{2}\widehat\Wb \quad \rightarrow \quad
...
\begin{equation}
\Fb^n = (\rho\chi\nabla c)^n + \sqrt{\frac{2\left(\chi\rho\mu_c^{-1}\right)^n k_B T}{\Delta t\Delta V}}\widetilde\Wb^n,
\end{equation}
...
\begin{equation}
\nabla(p^{n-\myhalf} + \delta p) = \mathcal A_0^n(\vb^{n-\myhalf} + \deltab\vb) + \nabla\cdot\sqrt{\frac{2\eta^n k_B T}{\Delta t\Delta V}}\widehat\Wb^n + \rho^n\gb,
\end{equation}
\begin{equation}
...
+ \nabla\cdot\sqrt{\frac{2\eta^n k_B T}{\Delta t\Delta V}}\widehat\Wb^n 
...
\begin{equation}
\Fb^{*,n+\myhalf} = (\rho\chi\nabla c)^{*,n+\myhalf}
+ \sqrt{\frac{2\left(\chi\rho\mu_c^{-1}\right)^{*,n+\myhalf}k_B T}{\Delta t\Delta V}}\widetilde\Wb^n
\end{equation}
{\bf Step 6: Corrector Stokes Solve:}\\ \\
Solve a steady Stokes system with $p^{n+\myhalf} = p^* + \delta p$ and $\vb^{n+\myhalf} = \vb^n + \delta\vb$:
\begin{equation}
\nabla(p^* + \delta p) = \mathcal A_0^{*,n+\myhalf}(\vb^* + \deltab\vb) + \nabla\cdot\sqrt{\frac{2\eta^{*,n+\myhalf} k_B T}{\Delta t\Delta V}}\widehat\Wb^n + \rho^{*,n+\myhalf}\gb,
\end{equation}
\begin{equation}
...
+ \nabla\cdot\sqrt{\frac{2\eta^{*,n+\myhalf} k_B T}{\Delta t\Delta V}}\widehat\Wb^n 
+ \rho^{*,n+\myhalf}\gb,
\end{equation}
\begin{equation}
