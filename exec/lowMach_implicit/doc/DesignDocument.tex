...
we use an ideal gas mixture for (\ref{eq:rho1 stoch}) with $\mu_c^{-1}k_BT \equiv c(1-c)$
...
\Fb^0 = (\rho\chi\nabla c)^0 + \sqrt{\frac{2(\chi\rho\mu_c^{-1})^0k_BT}{\Delta t\Delta V}}\widetilde\Wb^0.
\end{equation}
...
&&+ \half(\nabla\cdot\taub^n + \nabla\cdot\taub^{*,n+1}) + \nabla\cdot\sqrt{\frac{2\eta^{*,n+\myhalf} k_B T}{\Delta t\Delta V}}\widehat\Wb^n,\label{eq:CN Vel Pred}
\end{eqnarray}
\begin{equation}
...
&&\hspace{-1.0in}+ \Delta t\left\{\nabla\cdot(-\rho^n\vb^n\vb^n) + \half\nabla\cdot\taub^n + \nabla\cdot\sqrt{\frac{2\eta^{*,n+\myhalf} k_B T}{\Delta t\Delta V}}\widehat\Wb^n\right\}.\label{eq:CN Vel Pred2}
\end{eqnarray}
...
&&+ \half(\nabla\cdot\taub^n + \nabla\cdot\taub^{n+1}) + \nabla\cdot\sqrt{\frac{2\eta^{n+\myhalf} k_B T}{\Delta t\Delta V}}\widehat\Wb^n,\label{eq:CN Vel Corr}
\end{eqnarray}
\begin{equation}
\nabla\cdot\vb^{n+1} = S^{n+1}.
\end{equation}
