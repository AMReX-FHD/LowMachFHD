...
\end{equation}
where $\nb=(n_1,n_2,\cdots)$ are the number densities and $D_i$ are Fickean diffusion
coefficients.
...
increment $\delta t$, we have three options: tau-leaping, stochastic
simulation algorithm (SSA), and chemical Langevin equation (CLE).
