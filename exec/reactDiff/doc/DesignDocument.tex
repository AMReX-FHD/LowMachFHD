...
n_k^{n+1} = n_k^n + \delta t\nabla\cdot
D_k\nabla n_k^{n+\myhalf}
+ \sqrt{\frac{\delta t D_k n_k^n}{\Delta V}} \mZb^{(1)}
+ \sqrt{\frac{\delta t D_k n_k^{n+\myhalf}}{\Delta V}} \mZb^{(2)}
\end{equation}
...
D_k\nabla n_k^{n+\myhalf}
+ \sqrt{\frac{\delta t D_k n_k^n}{\Delta V}} \mZb^{(1)}
+ \sqrt{\frac{\delta t D_k \left( 2 n_k^{n+\myhalf} - n_k \right) }{\Delta V}} \mZb^{(2)}
\end{equation}
