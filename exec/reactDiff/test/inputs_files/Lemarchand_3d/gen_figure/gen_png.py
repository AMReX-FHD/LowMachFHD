...
if (len(sys.argv)!= 5):
  print "ERROR: four arguments needed (datavaseName,figureName,width,height)"
  print sys.argv[1:]
  sys.exit(0)
...
ThreeSliceAtts.x = 256
ThreeSliceAtts.y = 256
...
# I don't know why but need to call DrawPlots first to apply View3DAtts
View3DAtts = View3DAttributes()
visit.DrawPlots()

View3DAtts = View3DAttributes()
View3DAtts.viewNormal = (0.65, 0.65, 0.4)
View3DAtts.focus = (256, 256, 304)
View3DAtts.viewUp = (-0.28, -0.28, 0.92)
View3DAtts.viewAngle = 30
View3DAtts.parallelScale = 400
View3DAtts.nearPlane = -800
View3DAtts.farPlane = 800
View3DAtts.imagePan = (0, 0)
View3DAtts.imageZoom = 2
View3DAtts.perspective = 0
View3DAtts.eyeAngle = 2
View3DAtts.centerOfRotationSet = 0
View3DAtts.centerOfRotation = (256, 256, 256)
