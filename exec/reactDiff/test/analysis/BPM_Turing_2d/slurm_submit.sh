...
# OPT1: resolution
#OPT1="--n_cells_x 64  --n_cells_y 64  --max_grid_size_x 16 --max_grid_size_y 16"
...
#OPT3="--fixed_dt 0.5   --max_step  20000  --print_int  20  --n_steps_write_avg  2  --plot_int  0"
...
#OPT3="--fixed_dt 1.5   --max_step   5000  --print_int   5  --n_steps_write_avg  1  --plot_int 0"
#OPT3="--fixed_dt 2.    --max_step   3750  --print_int   5  --n_steps_write_avg  1  --plot_int 0"
#OPT3="--fixed_dt 2.5   --max_step   3000  --print_int   4  --n_steps_write_avg  1  --plot_int 0"
#OPT3="--fixed_dt 3.    --max_step   2500  --print_int   2  --n_steps_write_avg  1  --plot_int 0"
...
if [ RUNNO == "" ]
then
  OPT4="--use_bl_rng F --seed 1"
else
  ((SEED = 100*RUNNO))
  OPT4="--use_bl_rng T --seed_diffusion $RANDOM --seed_reaction $RANDOM --seed_init $SEED"
  echo $OPT4
fi
