...
\hline
Test 4: ($\chi$, q) & $c$ & 1.95e-03 & 1.99 & 4.91e-04 & x.xx & x.xxe-xx
\end{tabular}
\end{center}
\end{table}
...
\hline
Test 4: ($\chi$, q) & $c$ & 1.25e-04 & 1.99 & 3.14e-05 & x.xx & x.xxe-xx
\end{tabular}
\end{center}
\end{table}
...
\hline
Test 4: ($\chi$, q) & $c$ & 3.35e-04 & 1.94 & 8.76e-05 & x.xx & x.xxe-xx
\end{tabular}
\end{center}
\end{table}
