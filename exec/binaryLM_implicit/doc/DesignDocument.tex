...
Test 1: Inertial algorithm, centered scalar advection
Test 2: Inertial algorithm, unlimited BDS scalar advection, $\chi=0$.
Test 3: Overdamped algorithm, centered scalar advection
Test 4: Overdamped algorithm, unlimited BDS scalar advection, $\chi=0$.

Tests 5-8 are the same tests with higher-order transverse velocity ghost cell
extrapolation, which is suitable for deterministic problems where we seek second-order
in $L^{\rm inf}$, but not for stochastic simulations since the discretization does
not satify fluctuation-dissipation balance.
...
\hline
Test 2 with $\chi$: & $u$ & 6.77e-03 & 1.81 & 1.92e-03 & x.xx & x.xxe-xx \\
        & $v$ & 3.36e-03 & 1.89 & 9.05e-04 & x.xx & x.xxe-xx \\
        & $c$ & 6.94e-03 & 1.44 & 2.56e-03 & x.xx & x.xxe-xx \\
\hline
Test 3: & $c$ & 1.44e-02 & 1.94 & 3.74e-03 & 1.94 & 9.76e-04 \\
\hline
Test 4: & $c$ & 1.40e-02 & 1.69 & 4.34e-03 & 1.89 & 1.17e-03 \\
\hline
Test 4: with $\chi$ & $c$ & 6.75e-03 & 1.17 & 3.01e-03 & x.xx & x.xxe-xx \\
\hline
Test 4: no $\gb$ & $c$ & 1.07e-02 & 1.78 & 3.10e-03 & x.xx & x.xxe-xx \\
\hline
...
\hline
Test 2 with $\chi$: & $u$ & 7.37e-03 & 1.93 & 1.93e-03 & x.xx & x.xxe-xx \\
        & $v$ & 1.14e-03 & 1.92 & 3.01e-04 & x.xx & x.xxe-xx \\
        & $c$ & 6.21e-03 & 1.96 & 1.59e-03 & x.xx & x.xxe-xx \\
\hline
Test 3: & $c$ & 8.32e-04 & 1.99 & 2.09e-04 & 1.95 & 5.41e-05 \\
\hline
Test 4: & $c$ & 6.84e-04 & 1.99 & 1.72e-04 & 1.81 & 4.91e-05 \\
\hline
Test 4: with $\chi$ & $c$ & 6.36e-04 & 1.96 & 1.63e-04 & x.xx & x.xxe-xx \\
\hline
Test 4: no $\gb$ & $c$ & 6.71e-04 & 1.99 & 1.69e-04 & x.xx & x.xxe-xx \\
\hline
...
\hline
Test 2 with $\chi$: & $u$ & 1.28e-02 & 1.96 & 3.27e-03 & x.xx & x.xxe-xx \\
        & $v$ & 1.35e-03 & 1.93 & 3.53e-04 & x.xx & x.xxe-xx \\
        & $c$ & 1.41e-03 & 1.83 & 3.97e-04 & x.xx & x.xxe-xx \\
\hline
Test 3: & $c$ & 2.09e-03 & 2.02 & 5.16e-04 & 1.98 & 1.31e-04 \\
\hline
Test 4: & $c$ & 1.80e-03 & 1.88 & 4.89e-04 & 1.74 & 1.46e-04 \\
\hline
Test 4: with $\chi$ & $c$ & 1.46e-03 & 1.77 & 4.27e-04 & x.xx & x.xxe-xx \\
\hline
Test 4: no $\gb$ & $c$ & 1.71e-03 & 1.86 & 4.70e-04 & x.xx & x.xxe-xx \\
\hline
