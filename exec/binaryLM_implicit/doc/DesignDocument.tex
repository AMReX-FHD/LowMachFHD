...
\hline
Test 5:             & $c$ & 3.57e-03 & 2.01 & 8.89e-04 & 2.00 & 2.22e-04 \\
\hline
...
In Figure \ref{fig:square}, we show the concentration at $t=2$.
Centered advection
...
In fact, we run the limited quadratic BDS scheme to a longer time ($t=???$)
and show the results in Figure ???, noting that the method does a good job in preserving
...
other images represent the final ($t=2$) condition:
...
at $t=0,0.8,1.6,2.4,3.2$, and $4.0$.}
\label{fig:square2}
\end{center}
\end{figure}
