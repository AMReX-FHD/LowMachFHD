...
\hline
Test 8: & $c$ & 6.77e-04 & 1.91 & 1.80e-04 & 2.02 & 4.45e-05 \\
\hline
\end{tabular}
\end{center}
\end{table}
...
Test 1: & $u$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
        ...
        & $c$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
\hline
Test 2: & $u$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
        & $v$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
        & $c$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
\hline
Test 3: & $c$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
\hline
Test 4: & $c$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
\hline
Test 5: & $u$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
        & $v$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
        & $c$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
\hline
Test 6: & $u$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
        & $v$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
        & $c$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
\hline
Test 7: & $c$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
\hline
Test 8: & $c$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
\hline
\end{tabular}
\end{center}
\end{table}
