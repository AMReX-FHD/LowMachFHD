...
$\Delta t = 0.005$ and is reduced by a factor of 2 as the grid spacing
...
Test 2:             & $u$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
                    ...
                    & $c$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
\hline
Test 2: ($\chi$, b) & $u$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
                    & $v$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
                    & $c$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
\hline
Test 2: ($\chi$, q) & $u$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
                    & $v$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
                    & $c$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
\hline
...
\hline
Test 4: ($\chi$, b) & $c$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx \\
\hline
Test 4: ($\chi$, q) & $c$ & x.xxe-xx & x.xx & x.xxe-xx & x.xx & x.xxe-xx
\end{tabular}
\end{center}
\end{table}
