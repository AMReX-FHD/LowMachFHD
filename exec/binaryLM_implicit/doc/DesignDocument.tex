...
\begin{eqnarray}
\frac{\rho^{n+1}(\vb^n + \deltab\vb) - \rho^n\vb^n}{\Delta t} + \nabla(p^n+\delta p) &=& \half\nabla\cdot(-\rho^n\vb^n\vb^n - \rho^{*,n+1}\vb^{*,n+1}\vb^{*,n+1})\nonumber\\
&&\hspace{-1in}+ \half\left[\mathcal{A}_0^n\vb^n + \mathcal{A}_0^{n+1}(\vb^n + \deltab\vb)\right]\nonumber\\
...
\begin{eqnarray}
\left(\frac{\rho^{n+1}}{\Delta t} - \half\mathcal{A}_0^{n+1}\right)\deltab\vb + \nabla\delta p &=& \frac{(\rho^n-\rho^{n+1})\vb^n}{\Delta t} -\nabla p^n\nonumber\\
&&+ \half\nabla\cdot(-\rho^n\vb^n\vb^n - \rho^{*,n+1}\vb^{*,n+1}\vb^{*,n+1}) + \half(\mathcal{A}_0^n\vb^n + \mathcal{A}_0^{n+1}\vb^n )\nonumber\\
...
\subsection{Original Algorithm}
To modify the original algorithm, we replace equations (\ref{eq:alg1_1st_rho_adv}) and 
(\ref{eq:alg1_1st_rho1_adv}) in {\bf Step 1} with
\begin{eqnarray}
...
\end{eqnarray}
and then replace equations (\ref{eq:alg1_2nd_rho_adv}) and 
(\ref{eq:alg1_2nd_rho1_adv}) with
\begin{eqnarray}
