...
pressure, $h$ is the specific enthalpy, $h_k = \partial h/\partial w_k|_{T,P}$,
...
\quad
P_{w_k} = \left.\frac{\partial P}{\partial w_k}\right|_{\rho,T}.
\end{equation}
...
\end{eqnarray}
with $P_T/P_\rho=-\rho_T$ and $P_{w_k}/P_\rho=-\rho_{w_k}$ given by the triple rule,
and isothermal compressibility, thermal expansion coefficient, and solutal expansion coefficients given by
\begin{equation}
\kappa_T = \frac{1}{\rho P_\rho} = \frac{\rho_P}{\rho}, \quad
...
respect to $P$ and the triple rule.\\
...
\begin{equation}
\frac{Dw_k}{Dt} = \frac{1}{\rho}\left(-\nabla\cdot\Fb_k + \rho W\right),\label{eq:DwDt}
\end{equation}
