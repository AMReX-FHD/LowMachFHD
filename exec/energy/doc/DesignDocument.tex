...
and
\begin{equation}
\nabla\cdot\vb = \delta S - \delta\alpha\frac{dP_0}{dt}.\label{eq:constraint3}
\end{equation}
...
\begin{equation}
\nabla\cdot\vb = \delta S + \delta S_{\rm corr} - \delta\alpha\frac{dP_0}{dt},
\end{equation}
\begin{equation}
\bar{\alpha}\frac{dP_0}{dt} = \bar{S} + \bar{S}_{\rm corr}.
\end{equation}
...
\begin{eqnarray}
\frac{\rho^{n+1}h^{n+1,l+1} - (\rho h)^n}{\Delta t} &=& -\nabla\cdot(\rho h\vb)^{n+\myhalf} + \frac{dP_0}{dt}\nonumber\\
...
\begin{equation}
\nabla\cdot\vb^n = \delta S^n + \delta S_{\rm corr}^n - \delta\alpha^n\underbrace{\frac{\bar{S}^n + \bar{S}_{\rm corr}^n}{\bar{\alpha}^n}}_{dP_0/dt}.
\end{equation}
