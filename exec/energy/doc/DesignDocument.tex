...
\begin{itemize}
\item {\bf Step 0a:} Compute $(S,\alpha)^n$ decompose $(S,\alpha,S_{\rm corr})^n$ 
into average and perturbational components, and then compute a pressure update:
\begin{equation}
...
\begin{itemize}
\item {\bf Step 1a:} Compute $(S,\alpha)^{*,n+1}$ decompose $(S,\alpha,S_{\rm corr})^{*,n+1}$ 
into average and perturbational components, and then compute a pressure update:
\begin{equation}
