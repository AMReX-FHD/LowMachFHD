...
We loop over the following until the convergence criteria in {\bf Step 0d} is met:\\
\begin{itemize}
...
We loop over the following until the convergence criteria in {\bf Step 1d} is met:\\
\begin{itemize}
...
\end{equation}
\item {\bf Step 1b:} Compute the velocity field and the dynamic pressure by using a GMRES solver for the Stokes system,
pressure, $\pi^{*,n+1}$.
\begin{equation}
