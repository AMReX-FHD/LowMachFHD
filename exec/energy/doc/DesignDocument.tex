...
\end{equation}
\begin{equation}
\frac{P_0^{n+1} - P_0^n}{\Delta t} = \frac{\bar S + \bar S_{\rm corr}}{\bar\alpha},\label{eq:P0_update}
\end{equation}
with $S_{\rm corr}$ chosen so that the equation of state is satifised.  For gases, this means,
\begin{equation}
