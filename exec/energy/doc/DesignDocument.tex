...
\end{equation}
\begin{equation}
a_i(T) = 0.42748\frac{R^2T_{c,i}^2}{m_i^2 P_{c,i}}\left[1 + \left(0.48508 + 1.5517\bar\omega_i - 0.151613\bar\omega_i^2\right)\left(1-\sqrt{T_i^*}\right)\right]^2,
\end{equation}
with $T_i^* = T/T_{c,i}$ and $\bar\omega$ the acentric factor for component $i$.
\begin{equation}
