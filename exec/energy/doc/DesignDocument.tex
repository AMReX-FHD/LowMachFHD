...
\end{equation}
split this into average and perturbational components and then return to {\bf Step 0a}.
...
\end{equation}
split this into average and perturbational components and then
return to {\bf Step 1a}.  I think the factor of 2 is required here since the new-time
