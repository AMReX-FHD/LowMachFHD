...
\begin{equation}
\frac{DP}{Dt} = P_\rho\frac{D\rho}{Dt} + P_T\frac{DT}{Dt} + \sum_kP_k\frac{Dw_k}{Dt},\label{eq:particle paths}
\end{equation}
\begin{equation}
...
\quad
P_k = \left.\frac{\partial P}{\partial w_k}\right|_{\rho,T}.
\end{equation}
Next, by noting that by continuity $D\rho/Dt = -\rho\nabla\cdot\vb$, 
we can rewrite 
(\ref{eq:particle paths}) as
\begin{equation}
\nabla\cdot\vb = \frac{1}{\rho P_\rho}\left(-\frac{DP}{Dt} + P_T\frac{DT}{Dt} + \sum_kP_k\frac{Dw_k}{Dt}\right).\label{eq:constraint1}
\end{equation}
...
and using $P_k/P_\rho = -\rho_{w_k}$ and $P_T/P_\rho = -\rho_T$ gives
\begin{equation}
\nabla\cdot\vb + \theta\frac{DP}{Dt} = -\sum_k \frac{1}{\rho}\beta_k\left(-\nabla\cdot\Fb_k + \rho W\right) + \frac{1}{\rho c_p}\alpha\left[-\nabla\cdot\Qb - \sum_k\nabla\cdot h_k\Fb_k  + \rho H - \sum_k h_k\left(-\nabla\cdot\Fb_k + \rho W\right)\right] \equiv S,\label{eq:constraint}
\end{equation}
\begin{equation}
...
\begin{equation}
\rho_{w_k} = -\frac{P_k}{P_\rho}, \quad \rho_T = -\frac{P_T}{P_\rho}.
\end{equation}
...
%\begin{equation}
%\frac{dP_0}{dt} = P_\rho\frac{D\rho}{Dt} + P_T\frac{DT}{Dt} + \sum_kP_k\frac{Dw_k}{Dt}.\label{eq:particle paths2}
%\end{equation}
...
\begin{equation}
\frac{dP_0}{dt} = P_\rho\frac{D\rho}{Dt} + P_T\frac{DT}{Dt} + \sum_kP_k\frac{Dw_k}{Dt}.
\end{equation}
...
\end{equation}
\begin{equation}
P_k = \left(\frac{\mathcal{R}T}{v-b(\wb)}\right)\frac{1}{m_k}
